...
def fnt_inicio(request):
    ...
    return render(request, 'indiewebapp/inicio.html', {'juegos' : carta_juego,
...
def fnt_detalle(request, nombre):
    ...
    return render(request, 'indiewebapp/detalle.html', {'detalle_juego': detalle_juego})
...
def fnt_unity(request):
    ...
    return render(request,'indiewebapp/unity.html', {'juegos_unity' : carta_juego_unity} )

def fnt_rpgmaker(request):

    carta_juego_rpgmaker = Tbl_juegos.objects.filter(fkidJuegos_idMotor__nombre = 'rpgmaker')

    return render(request, 'indiewebapp/rpgmaker.html', {'juegos_rpgmaker' : carta_juego_rpgmaker})

def fnt_politicas(request):
    return render(request, 'indiewebapp/politicas.html')